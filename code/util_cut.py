...
def deal_pic(input1, input2, output):
    ...
    img_after = Image.open(input2)
    img_before = Image.open(input1)
    # img.show()
...
if __name__ == '__main__':
    ...
    for imgpath in imglist:
        ...
        input1 = "E:/shezhen/fengei/ordata/" + imgname + ".jpg"
        input2 = "E:/shezhen/fengei/notedata/" + imgname + ".jpg"
        output = "E:/shezhen/fengei/deal_img/" + imgname + ".png"
        deal_pic(input1, input2, output)
    print("over")
